# BadgerDB [![GoDoc](https://godoc.org/github.com/FormantIO/badger?status.svg)](https://godoc.org/github.com/FormantIO/badger) [![Go Report Card](https://goreportcard.com/badge/github.com/FormantIO/badger)](https://goreportcard.com/report/github.com/FormantIO/badger) [![Build Status](https://teamcity.dgraph.io/guestAuth/app/rest/builds/buildType:(id:Badger_UnitTests)/statusIcon.svg)](https://teamcity.dgraph.io/viewLog.html?buildTypeId=Badger_UnitTests&buildId=lastFinished&guest=1) ![Appveyor](https://ci.appveyor.com/api/projects/status/github/FormantIO/badger?branch=master&svg=true) [![Coverage Status](https://coveralls.io/repos/github/FormantIO/badger/badge.svg?branch=master)](https://coveralls.io/github/FormantIO/badger?branch=master)
...
[Changelog]:https://github.com/FormantIO/badger/blob/master/CHANGELOG.md
...
[v1.0.1]: //github.com/FormantIO/badger/tree/v1.0.1
[v0.8.1]: //github.com/FormantIO/badger/tree/v0.8.1
[v0.9.0]: //github.com/FormantIO/badger/tree/v0.9.0
...
```sh
$ go get github.com/FormantIO/badger/...
```
...
[metrics]: https://github.com/FormantIO/badger/blob/master/y/metrics.go
...
[badger-bench]: https://github.com/FormantIO/badger-bench
...
Please see Github issues [#293](https://github.com/FormantIO/badger/issues/293)
and [#315](https://github.com/FormantIO/badger/issues/315).
...
- Please use [Github issue tracker](https://github.com/FormantIO/badger/issues) for filing bugs or feature requests.
